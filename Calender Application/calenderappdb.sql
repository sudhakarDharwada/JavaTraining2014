  ...
  CREATE TABLE USER_LOGIN 
   (    EMAIL VARCHAR2(20), 
	...
	USER_SEQ_ID NUMBER NOT NULL, 
	 CONSTRAINT USER_LOGIN_FK FOREIGN KEY (USER_SEQ_ID)
	  REFERENCES TEAMS_USER (TEAMS_USER_SEQID)
   );

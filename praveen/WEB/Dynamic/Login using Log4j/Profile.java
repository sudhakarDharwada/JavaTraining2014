...
//		PropertyConfigurator.configure("/home/praveen/workspace/LoginProperty/src/mylog4j.properties");
		...
		try{
			...
			if(name!=null){
				...
				log.info("no value in the session");

...
public class SaxHandler extends DefaultHandler{
	...
	private com.vl.school.beans.Class class1;
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes)
		...
		if(qName.equalsIgnoreCase("Details")){
			...
			if(class1==null){
				class1=new com.vl.school.beans.Class();
			}
		}
	...
	public void display(){
		List<Teacher> list;
		List<com.vl.school.beans.Class> classList;
		...
		for(com.vl.school.beans.Class c:classList){
